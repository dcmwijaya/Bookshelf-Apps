...
![GitHub last commit](https://img.shields.io/github/last-commit/devancakra/Bookshelf-Apps?logo=Codeforces&logoColor=white&color=%23F7DF1E)
...
3. Pindahkan direktori ``` Bookshelf-Apps ``` ke dalam direktori ``` htdocs ```, yang rinciannya dapat anda lihat sebagai berikut: ``` C:\xampp\htdocs ```.<br><br>
4. Untuk mengakses situs web, buka ``` XAMPP ```, lalu mulai bagian ``` Apache ```.<br><br>
5. Silakan buka ``` peramban ``` anda dengan menuliskan: ``` localhost/Bookshelf-Apps/ ```.<br><br>
6. Periksa bagian Penyimpanan Lokal:<br><br>
   ...
   • Pastikan tampilannya seperti gambar berikut ini:<br><br><img width="810" src="assets/documentation/Local Storage.jpg" alt="local-storage"><br><br>
